...
#
# Script generated by Vivado on Fri Jun 27 11:31:32 +0900 2025
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L smartconnect_v1_0 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L blk_mem_gen_v8_4_9 -L generic_baseblocks_v2_1_2 -L fifo_generator_v13_2_11 -L axi_data_fifo_v2_1_32 -L axi_register_slice_v2_1_33 -L axi_protocol_converter_v2_1_33 -L axi_clock_converter_v2_1_32 -L axi_dwidth_converter_v2_1_33 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L xlconstant_v1_1_9 -L smartconnect_v1_0 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot system xil_defaultlib.system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim system -key {Behavioral:sim_1:Functional:system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_919a.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
