...
HD_PWD='C:/lab1/MicroPhase-Z7-Lite-Board/examples/idec/lab3/edt_zc702/edt_zc702.runs/system_Blink_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_Blink_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_Blink_0_0.tcl
